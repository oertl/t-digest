 ...
 *
 */
public class AVLTreeDigest2 extends AbstractTDigest {
     ...
     *                    accuracy.
     */
    public AVLTreeDigest2(double compression) {
     ...
     */
    public static AVLTreeDigest2 fromBytes(ByteBuffer buf) {
        int encoding = buf.getInt();
        if (encoding == VERBOSE_ENCODING) {
            double compression = buf.getDouble();
            AVLTreeDigest2 r = new AVLTreeDigest2(compression);
            int n = buf.getInt();
